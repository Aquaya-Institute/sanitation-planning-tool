export const madagascar = {
  ...
  layers: [
    ...
    {
      name: "5x5km area",
      carto_tableName: "mdg_multivariable_pixel",
      carto_source: null,
      carto_layer: null,
      carto_style: `#layer {polygon-fill: ramp([classes], (#3d4bc7, #4f9130, #bf4343, #c49755), (1, 2, 3, 4), '=', category);} #layer::outline {line-width: 0;line-color: #ffffff;line-opacity: 0;}`,
      visible: true,
      ...
      filters: [
        ...
        {
          name: "Province (Faritany mizakatena)",
          type: "none",
          column_name: "name_1",
          subcategory: "id",
        },
    ...
    {
      name: "Department",
      carto_tableName: "mdg_multivariable_dist",
      carto_source: null,
      carto_layer: null,
    ...
    },
    {
      ...
      carto_tableName: "mdg_multivariable_comms",
      carto_layer: null /* we will insert carto's layer object here */,
      carto_source: null,
      ...
      filters: [
        ...
        },
        {
          ...
          scaledMin: 0,
          scaledMax: 2532391,
          scaledValue: [0, 2532391], //the actual min/max of column
          subcategory: "socioeconomic",
          // define 7+1 non linear marks here, note that value goes from 0-70 only
          marks: [
            {
