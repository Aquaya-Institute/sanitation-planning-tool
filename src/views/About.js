    ...
    <>
      ...
      <br></br>
        ...
        <strong>What</strong> is the SanPlan tool?
          ...
          <br></br>
          SanPlan saves sanitation practitioners the time and challenges of collecting, 
          analyzing, and mapping data to inform their program design by giving them access 
          to key contextual data required for planning sanitation programs all in one place. 
          SanPlan brings together data on settlement-level accessibility, environmental, 
          demographic, socioeconomic, and WASH factors and displays the information spatially 
          within a map. Users can explore trends and patterns within a geographic area, or use 
          the built in filters and sliders to customize their analysis and download detailed, 
          granular data on their area of interest.
        </Box>
        <Box  p={2}>
        <Typography variant="h5" color="secondary" p={2}>
          ...
          <br></br>
          The tool is designed for anyone in the planning or budgeting phase of a sanitation project 
          at the national, regional or local scale. Typical users might include government agencies, 
        ...
        <strong>How</strong> does the tool work? 
          ...
          allows users to click anywhere on the map and access information on key contextual factors. Because 
          GPS locations for communities are often unknown or difficult to obtain, SanPlan has developed its own 
          method for identifying communities and settlements of all sizes on the map. (You can learn more about 
          this below).  In the future, users will be able to upload their own community locations and data and 
          have them visualized in the map. 
        </Box>
        </Paper>
