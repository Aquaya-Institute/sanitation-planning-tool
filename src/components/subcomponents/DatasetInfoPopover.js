...
import { Container, Grid, Box, Typography, Card, CardContent, Button } from "@material-ui/core";
                        ...
                        <CardContent>
                          ...
                          {selectedDataset.remote && (
                            <>
                                <ul>
                                    <li>
                                        <strong>Rural Mixed:</strong> {selectedDataset.mixed}
                                    </li>
                                    <li>
                                        <strong>Rural On-road:</strong> {selectedDataset.road}
                                    </li>
                                    <li>
                                        <strong>Rural Remote:</strong> {selectedDataset.remote}
                                    </li>
                                </ul>
                            </>
                          )}
                          <Typography color="textSecondary">{selectedDataset.note}</Typography>
                          <Typography variant="body1">Year: {selectedDataset.year}</Typography>
